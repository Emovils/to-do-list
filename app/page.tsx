...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen font-sans bg-gradient-to-tr from-blue-100 to-sky-200 overflow-hidden">
      {/* Left section - Login */}
      <div
        className={`flex flex-col justify-center items-center w-full md:w-1/2 bg-white/80 backdrop-blur-sm p-8 rounded-r-3xl shadow-2xl transform transition-all duration-700 ${
